    ...
    public struct HostString:IEquatable<HostString>
    {
        ...
        public string ToUriComponent()
        {
            ...
            if (i != _value.Length)
            {
                ...
                var encoded = mapping.GetAscii(host, 0, host.Length);
        ...
        /// </remarks>
        /// <returns></returns>
        public static bool MatchesAny(string value, IList<string> patterns)
        {
            if (value == null)
            {
            ...
            for (int i = 0; i < patterns.Count; i++)
            {
                ...
                {
                    // .example.com
                    var allowedRoot = pattern.Substring(1);

                    var hostRoot = host.Substring(host.Length - allowedRoot.Length);
