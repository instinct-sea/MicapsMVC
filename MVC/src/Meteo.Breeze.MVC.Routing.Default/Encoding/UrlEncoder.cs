...
namespace Meteo.Breeze.MVC.Routing.Default.Encoding
{
    /// <summary>
    ...
    internal sealed class DefaultUrlEncoder : UrlEncoder
    {
        ...
        internal static readonly DefaultUrlEncoder Singleton = new DefaultUrlEncoder(new TextEncoderSettings(UnicodeRanges.None));
        ...
        public unsafe override bool TryEncodeUnicodeScalar(int unicodeScalar, char* buffer, int bufferLength, out int numberOfCharactersWritten)
        {
            ...
            do
            {
                char highNibble='\0', lowNibble='\0';
                //modify by jiayongqiang 2018.7.6
