...
namespace Meteo.Breeze.MVC.Routing.Default.Template
{
    public static class TemplateParser
    {
        ...
        public static RouteTemplate Parse(string routeTemplate)
        {
            ...
            while (context.Next())
            {
                if (context.Current == Separator)
                {
                    ...
                    throw new ArgumentException("invlaid segement",
        ...
        private static string TrimPrefix(string routeTemplate)
        {
            ...
            {
                throw new ArgumentException("~ invalid segement", nameof(routeTemplate));
            }
