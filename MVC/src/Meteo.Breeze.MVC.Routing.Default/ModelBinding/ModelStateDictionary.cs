...
using Meteo.Breeze.MVC.Routing.Default.ModelBinding.ModelBinding;
using Meteo.Breeze.MVC.Routing.Default.Formatters;
...
namespace Meteo.Breeze.MVC.Routing.Default.ModelBinding
{
    ...
    public class ModelStateDictionary : IReadOnlyDictionary<string, ModelStateEntry>
    {
        ...
        public void MarkFieldValid(string key)
        {
            ...
            {
                throw new InvalidOperationException("Validation_InvalidFieldCannotBeReset");
            }
