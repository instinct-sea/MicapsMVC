...
{
    public abstract class HttpRequestStream : ReadOnlyStream
    {
        ...
        protected abstract Task<int> ReadAsyncInternal(byte[] buffer, int offset, int count, CancellationToken cancellationToken);
        ...
        protected abstract Task CopyToAsyncInternal(Stream destination, CancellationToken cancellationToken);
